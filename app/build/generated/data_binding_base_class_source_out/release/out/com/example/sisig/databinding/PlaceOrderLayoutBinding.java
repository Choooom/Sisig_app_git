...
public final class PlaceOrderLayoutBinding implements ViewBinding {
  ...
  private PlaceOrderLayoutBinding(@NonNull LinearLayout rootView, @NonNull Button addOrderButton,
      @NonNull Button cancelButton, @NonNull Button confirmButton, @NonNull Button decreaseQuantity,
  ...
  public static PlaceOrderLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new PlaceOrderLayoutBinding((LinearLayout) rootView, addOrderButton, cancelButton,
          confirmButton, decreaseQuantity, increaseQuantity, menuDescription, menuDisplayLayout,
          menuImage, menuName, menuPrice, menuServing, orderHeader, quantity, totalCost,
          totalCostLabel);
    }
