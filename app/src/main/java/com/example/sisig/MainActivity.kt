...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Commenting out all initialization and listeners
        ...
        // Commenting out biometric prompt setup and usage
        // setupBiometricPrompt()
        // showBiometricPrompt()

        // Directly navigate to the DashboardActivity
        startActivity(Intent(this, DashboardActivity::class.java))
        finish()
    }

    // Commenting out the entire biometric prompt setup
    /*
    ...
    */
    ...
    // Commenting out the login handling code
    /*
    ...
    */
    ...
    // Commenting out the password reset activity opening
    /*
